...
public class Server {
    ...
    public static void startInfoServer() {
        new Thread(() -> {
            try{
                infoServerSocket = new ServerSocket(INFO_PORT, 50, InetAddress.getByName("192.168.219.242"));
    ...
    public static void startMainServer() {
        new Thread(() -> {
            try (ServerSocket mainServerSocket = new ServerSocket(MAIN_PORT, 50, InetAddress.getByName("192.168.219.242"))) {
